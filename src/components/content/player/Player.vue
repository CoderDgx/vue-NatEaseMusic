  ...
  <div class="player">
    ...
    >
      <div class="normal-player" v-show="fullScreen">
        ...
        <div class="top">
          ...
          <h2 class="subtitle">{{currentSongArtists}}</h2>
        </div>
        <div class="middle"
    ...
    <transition name="mini">
      <div class="mini-player" v-show="!fullScreen" @click="open">
        <div class="icon">
          <img :class="cdCls" width="40" heoght="40" :src="currentSong.al.picUrl">
        </div>
        <div class="text">
          <h2 class="name">{{currentSong.name}}</h2>
          <p class="desc">{{currentSongArtists}}</p>
        </div>
        <div class="control">
